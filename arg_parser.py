...
def get_args():
    ...
    filter_parser.add_argument("--transfer_func_patterns", "-p", type=bool, choices=[True, False], default = False, help="if set it to True, the job will try to parse transfer functions using predefined patterns. It will fail if it finds a new pattern")
    filter_parser.add_argument("--job_id", "-j", type=str, default='0', help="job id for running multiple jobs")
