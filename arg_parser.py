...
def get_args():
    ...
    cf_parser = subparsers.add_parser("contracts_from", help="export contracts that are called from the input contract given the blocknumber")
    ...
    ct_parser = subparsers.add_parser("contracts_to", help="export contracts that make calls to the input contract given the blocknumber")
