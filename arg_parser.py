...
def get_args():
    ...
    cf_parser.add_argument("--addr", "-a", type=str, required=True, help="Contract address of interest (from)")
    ...
    ct_parser.add_argument("--addr", "-a",type=str, required=True, help="Contract address of interest (to)")
    ...
    txt_parser.add_argument("--addr", "-a",type=str, required=True, help="Contract address of interest (to)")
    ...
    trt_parser.add_argument("--addr", "-a",type=str, required=True, help="Contract address of interest (to)")
    ...
    txf_parser.add_argument("--addr", "-a",type=str, required=True, help="Contract address of interest (from)")
    ...
    trf_parser.add_argument("--addr", "-a",type=str, required=True, help="Contract address of interest (from)")
